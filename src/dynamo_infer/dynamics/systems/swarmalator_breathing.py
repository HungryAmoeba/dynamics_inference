...
class SwarmalatorBreathing(InteractingParticleSystem):
    ...
    def unwrap_state(self, state):
        ...
        Returns:
            ...
            - 'orientations': (T, N, D) array for orientations
            - 'volumes': (T, N, 1) array for volumes
        """
        ...
        return {"positions": pos, "orientations": ori, "volumes": vol}
