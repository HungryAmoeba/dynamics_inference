...
from ...inference.feature_library.monomial import MonomialPolynomialLibrary

from typing import List, Dict, Optional


class InteractingGA(InteractingParticleSystem):
    ...
    def unwrap_state(self, state: jnp.ndarray):
        ...
        Returns:
            ...
            - 'positions': (N, D) or (T, N, D) array for grade-1 elements
            - 'orientations': (N, D) or (T, N, D) array for grade-2 elements
        """
