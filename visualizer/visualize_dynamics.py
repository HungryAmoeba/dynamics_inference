...
def visualize_dynamics(cfg, pos, ori=None, save_path = None):
    ...
    if cfg.method == "matplotlib":
        ...
        if save_path is None:
            ...
            random_file_name = f"animation_{datetime.datetime.now().strftime('%Y%m%d_%H%M%S')}.mp4"
        ...
        raise ValueError(f"Visualization method '{cfg.visualizer.method}' is not supported. "
